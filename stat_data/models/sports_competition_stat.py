...
class SportsCompetitionStat(models.Model):
    ...
    # 学号
    student_id = models.CharField(max_length=20, verbose_name="学号", null=True)
    # 姓名
    full_name = models.CharField(max_length=20, verbose_name="姓名", null=True)
    # 学院
    unit_name = models.CharField(max_length=20, verbose_name="学院", null=True)
    # 竞赛类型
    ...
    # 项目
    sports_events = models.CharField(max_length=20, verbose_name="项目", null=True)
    # 成绩
